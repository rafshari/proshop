...
const OrderScreen = () => {
  ...
  if (!loading) {
    //calculate
    order.itemsPrice =  commaNumber(order.orderItems.reduce((acc, item) => acc + item.price * item.qty, 0))
