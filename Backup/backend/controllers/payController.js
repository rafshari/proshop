...
// @desc    post intent to zarinpal
// @route   POST /api/payment
// @access  private
const zarinpal = asyncHandler(async (req, res) => {
  //////////////////////////1- intent /////////////////////////
  let params = {merchant_id: process.env.ZARIN_PAL_MERCHANT_ID,amount: req.body.amount,callback_url: 'http://localhost:5000/api/payment/callback', description: 'افزایش اعتبار حساب کاربری ', metadata: [{ orderId: req.body.orderId }],}
...
const callback = async (req, res, next) => {
  ...
  try {
    ...
    ///////////////////////  5- verification ///////////////////////////////////////////
    const receipt = await axios.post('https://api.zarinpal.com/pg/v4/payment/verify.json',params)
